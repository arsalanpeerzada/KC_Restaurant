...
public class    DbHandler extends SQLiteOpenHelper {
    ...
    public static DbHandler getInstance(){
        return handler!=null?handler:(handler = new DbHandler(AppClass.getCtx()));
    }

    public static DbHandler newInstance(){
        return handler = new DbHandler(AppClass.getCtx());
    }
...
//        DATABASE_PATH = Environment.getExternalStorageDirectory()+"/SmartRestaurant/db/";
        ...
        try {
            ...
            else AppLog.d("DbHelper","creating Db Error: Permission Error");
